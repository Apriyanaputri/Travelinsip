            ...
            <div style="padding-top: 125px;">
                ...
                <div class="container" style="width: 500px;">
                    <form method="post" action="signup_p.php">
                        ...
                        <a href="signup_p.php" style="font-family: segoe ui light;"><button
                                class="btn waves-effect blue">Sign Up <i
                                    class="ion-android-person-add"></i></button></a>
                    </form>
                    <p class="left">Anda sudah punya akun? Silahkan langsung Sign In.</p><a href="signin.php"
                        style="font-family: segoe ui light;"><button class="btn waves-effect">Sign In <i
                                class="ion-log-in"></i></button></a>
                </div>
            </div>
        </center>
    </div>
