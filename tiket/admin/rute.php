        ...
        <div class="row">
            ...
            <div class="col s12">
                <div class="card-panel">
                    <h3><i class="ion-plus"></i> Tambahkan Rute</h3>
                    <form method="post" action="rute_t.php">
                        ...
                        <div class="input-field">
                            ...
                            <label for="rutf">Rute awal</label>
                        </div>
                        <div class="input-field">
                            <input type="text" name="rute_to" id="rutt" required>
                            <label for="rutt">Rute Tujuan</label>
                        </div>
                        <div class="input-field">
                        ...
                        <select name="id_trans" class="browser-default">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                <option value="<?php echo $row['id_trans'] ?>">
