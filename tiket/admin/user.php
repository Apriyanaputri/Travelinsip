...
<head>
    <title>Travelisip | Mode Admin</title>
                        ...
                        <tbody class="white-text">
                            ...
                            while ($dtt = mysqli_fetch_array($sql)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="user_d.php?id_user=<?= $dtt['id_user']; ?>"
                                            onclick="return confirm('Admin Yakin ingin menghapusnya?');"><button
                                                class="btn waves-effect red white-text"><i
                                                    class="ion-android-delete"></i></button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
