        ...
        <div class="row">
            ...
            <div class="col s12">
                <div class="card-panel">
                    <h3><i class="ion-plus"></i> Tambahkan transportasi</h3>
                    <form method="post" action="trans_t.php">
                        ...
                        <select name="id_trans_type" class="browser-default" required>
                            <option selected disabled>Type: </option>
                            <?php
                            include 'koneksi.php';
                            $result = mysqli_query($conn, "SELECT * FROM type_trans ");
                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                <option value="<?php echo $row['id_trans_type'] ?>">
