...
<head>
    <title>Travelisip | Penyedia Tiket terlucu</title>
...
<body>
    ...
    <div class="container">
        <div class="">
            <div class="row tiket-r">
                <div class="col s5 t-content1">
        ...
        <div class="row">
            ...
            <div class="col s12">
                <b>Nb: </b><i>Sebelum mencari tiket, Pastikan anda sudah mengisi data diri anda</i> <a
                    href="pengaturan.php"><button class="btn waves-effect green"><i
