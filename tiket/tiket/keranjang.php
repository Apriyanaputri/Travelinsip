            ...
            <div class="col s12">
                <div class="card-panel default">
                    <center>
                        ...
                        <b>Nb:</b> <i>sebelum cetak tiket, anda harus mengisi data diri anda.</i><a
                            href="pengaturan.php"><button class="btn waves-effect grey"><i
                                    class="ion-ios-settings"></i></button></a>
                    </center>
                </div>
            </div>
            <div class="col s4">
                    ...
                    <div class="card-panel green">
                        ...
                        <p>
                            ...
                            if ($query['status'] == 'Proses') {
                                ...
                                ?>
                                <a href="cetak.php?id_reserv=<?= $query['id_reserv']; ?>" target="_blank"><button
                                        class="btn waves-effect blue"><i class="ion-android-print"></i></button></a>
                                <?php
                            }
                            ?>
                        </p>
